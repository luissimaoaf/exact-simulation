    ...
    while sim_count < n_sim:
        ...
        while t < T:
            ...
            while rejected:
                ...
                all_times = candidate_times + test_times
                ...
                if i == a:
                    ...
                    test_factor_1 = (u*K < np.exp(integrated_drift(y + candidate_bridge[min(tau, T-t)])))
                    ...
                    if test_factor_1 and test_factor_2 and test_factor_3:
                        ...
                        rejected = False
                        if stopping_time < T:
                            if t < 0.5 < stopping_time:
                                mid_samples.append(f_inv(y+candidate_bridge[0.5-t]))
                    ...
                    if test_factor_1 and test_factor_2 and test_factor_3:
                        ...
                        if t < 0.5 < stopping_time:
                            mid_samples.append(f_inv(y+candidate_bridge[0.5-t]))
                        if stopping_time < 0.5:
                            mid_samples.append(0)
